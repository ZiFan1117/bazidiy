...
import { inferWuxing, validateConsistency, loadRelations } from '../src/_atoms/infer_verdict/index.ts'
import { beadCount, loadStyles, wuxingOrder } from '../src/_atoms/solve_styles/index.ts'
import { propose } from '../src/_atoms/propose_designs/index.ts'
