/**
 * bazidiy.styles —— 从款式库构建 Style/Position/Constraint，并提供候选过滤与约束校验器。
 * 数据来自 bazidiy.kb 的 styleLibrary；求解（枚举组合）在 bazidiy.solve_styles。
 * @module @bazidiy/ontology/atoms/styles
 */
 ...
 * @param type - 约束类型（diameter/spacer_map/same_bead）。
 * @param beads - 按 variables 顺序取出的珠子。
 * @param params - 约束参数。
 * @returns 是否满足约束。
 */
