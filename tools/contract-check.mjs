...
const strengthM = await import(B + 'atoms/rules/strength.ts')
const verdictM = await import(B + 'atoms/rules/verdictChoice.ts')
const consM = await import(B + 'atoms/rules/consistency.ts')
const selectM = await import(B + 'atoms/selectBeads.ts')
